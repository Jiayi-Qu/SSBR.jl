function sampleEffectsBayesB!(mats::GibbsMats,current::Current,out::Output)
    ...
    loglocusEffectVar = log(varResidual.locusEffectVar)
    ...
    out.meanMarkerEffects +=  (u - out.meanMarkerEffects)*iIter
    out.modelFreq         +=  (δ - out.modelFreq)*iIter
    #return nLoci #nLoci can be added to type current later
end
